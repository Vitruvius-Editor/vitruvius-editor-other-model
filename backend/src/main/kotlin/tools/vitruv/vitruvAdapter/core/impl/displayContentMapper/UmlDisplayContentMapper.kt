...
class UmlDisplayContentMapper : DisplayContentMapper<UmlDiagram> {
     ...
     */
    override fun parseContent(content: UmlDiagram): String = objectMapper.writeValueAsString(content)
     ...
     */
    override fun parseString(content: String): UmlDiagram = objectMapper.readValue(content, UmlDiagram::class.java)
     ...
     */
    override fun getVisualizerName(): String = VisualizerType.UML_VISUALIZER.visualizerName
}
