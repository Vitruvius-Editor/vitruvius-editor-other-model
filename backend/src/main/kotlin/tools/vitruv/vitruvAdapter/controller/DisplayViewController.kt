...
class DisplayViewController {
    ...
    fun getDisplayViews(@PathVariable projectId: UUID): ResponseEntity<List<DisplayViewResponse>> {
        TODO("Not yet implemented")
    }

    @GetMapping("/connection/{projectId}/displayView/{displayViewName}")
    fun getDisplayViewDetails(@PathVariable projectId: UUID, @PathVariable displayViewName: String): ResponseEntity<DisplayViewDetailsResponse> {
        TODO("Not yet implemented")
    }

    @PostMapping("/connection/{projectId}/displayView/{displayViewName}")
    fun getDisplayViewWindowContent(@PathVariable projectId: UUID, @PathVariable displayViewName: String, @RequestBody windowSelectionRequest: WindowSelectionRequest): ResponseEntity<String> {
        TODO("Not yet implemented")
    }

    @PutMapping("/connection/{projectId}/displayView/{displayViewName}")
    fun editDisplayViewContent(@PathVariable projectId: UUID, @PathVariable displayViewName: String, @RequestBody updatedContent: String): ResponseEntity<Unit> {
        TODO("Not yet implemented")
    }
}