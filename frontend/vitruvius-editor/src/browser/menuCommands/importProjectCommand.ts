import {Command, CommandContribution, CommandRegistry, MessageService, QuickInputService} from "@theia/core";
                    ...
                    this.quickInputService.input({title: 'Enter a description for the project.'}).then(description => {
                        this.quickInputService.input({title: 'Enter the URL of the Vitruvius server.'}).then(url => {
                            ...
                            this.connectionService.createConnection({
                                ...
                                this.displayViewWidgetContribution.widget.then(widget => widget.loadProject(connection));
