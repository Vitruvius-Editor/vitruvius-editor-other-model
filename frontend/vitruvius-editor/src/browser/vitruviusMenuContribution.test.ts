...
import { VitruviusMenuContribution, VitruviusMenu } from "./vitruviusMenuContribution";
...
describe("VitruviusMenuContribution", () => {
    ...
    beforeEach(() => {
        ...
        menuRegistry = { registerSubmenu: jest.fn(), registerMenuAction: jest.fn() } as unknown as jest.Mocked<MenuModelRegistry>;
    ...
    it("should register the Vitruvius submenu", () => {
        ...
        expect(menuRegistry.registerSubmenu).toHaveBeenCalledWith(VitruviusMenu.VITRUVIUS, "Vitruvius");
    });

    it("should register the HelpCommand", () => {
        contribution.registerMenus(menuRegistry);
        expect(menuRegistry.registerMenuAction).toHaveBeenCalledWith(VitruviusMenu.VITRUVIUS, {
