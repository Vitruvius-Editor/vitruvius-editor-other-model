    ...
    return (
        <div className="vitruvius-help">
          ...
          <ol>
            ...
            <li>3. Falls ein Server auf dem angegebenen Port existiert, wird das Projekt automatisch geladen.</li>
            <li>4. Falls bereits mehrere Server eingebunden sind, können sie über den Befehl &quot;Vitruvius Load Project&quot; im Vitruvius-Menü ausgewählt und geladen werden.</li>
          </ol>

          <h2>Views öffnen</h2>
          <ol>
            <li>1. Das Fenster &quot;Vitruvius&quot; in der linken Taskbar öffnen.</li>
            <li>2. Im Fenster werden alle verfügbaren View-Typen angezeigt.</li>
            <li>3. Einen View-Typ anklicken – dieser klappt sich aus und zeigt alle zugehörigen Views an.</li>
            <li>4. Eine gewünschte View auswählen, um sie zu öffnen. Diese wird dann in der Main Area der Theia IDE dargestellt.</li>
          </ol>

          <h2>Vitruvius Views editieren</h2>
          <ol>
            <li>1. Gewünschte View öffnen</li>
            <li>2. Änderungen vornehmen, z.B. Code-Änderungen am Source Code vornehmen oder editierbare Kacheln einer Tabelle anpassen.</li>
            <li>3. Änderungen auf das Model mit dem Vitruvius-Server synchronisieren mit dem &quot;Vitruvius Refresh Project&quot; Command.</li>
            <li>4. Die zu synchronisierende Datei auswählen.</li>
          </ol>

          <h2>Vitruvius-Projekt löschen</h2>
          <ol>
            <li>1. Den Befehl &quot;Vitruvius Delete Project&quot; im Vitruvius-Menü auswählen.</li>
            <li>2. Das zu löschende Projekt auswählen.</li>
          </ol>
          <p>Dies entfernt lediglich die Verbindung zum Vitruvius-Server, das eigentliche Projekt bleibt bestehen.</p>
